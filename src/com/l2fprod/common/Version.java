...
public class Version {
   ...
   private static String buildTimestamp = new String("03/17/2007 03:13 PM"); //$NON-NLS-1$
   ...
   private static String year = new String("2005-2007"); //$NON-NLS-1$
   ...
   private static String version = new String("7.3"); //$NON-NLS-1$
   ...
   private static String project = new String("l2fprod-common"); //$NON-NLS-1$
