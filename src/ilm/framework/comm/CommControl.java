...
public class CommControl implements ICommunication {
	...
	public Vector readAssignmentFiles(String packageName, Vector assignmentList) {
		try {
			return _encrypter.decryptFromFile(_fileRW.readAssignmentFiles(
					packageName, assignmentList));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public ZipFile writeAssignmentPackage(String packageName, String metadata,
		...
		try {
			return _fileRW.writeAssignmentPackage(packageName, metadata,
					resourceNameList, resourceList, assignmentNameList,
