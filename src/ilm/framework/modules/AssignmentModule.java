...
public abstract class AssignmentModule extends IlmModule implements Observer,
		Cloneable {
	...
	public abstract void setContentFromString(DomainConverter converter,
			int index, String moduleContent);
