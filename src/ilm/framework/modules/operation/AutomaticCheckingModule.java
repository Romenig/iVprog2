...
public class AutomaticCheckingModule extends OperationModule {
	...
	public AutomaticCheckingModule(IAssignment assignments,
			IAssignmentOperator operator) {
	...
	public float getEvaluation() {
		...
		return _model.AutomaticChecking(
	...
	public boolean hasExpectedAnswer() {
		...
		if (_assignmentList.getExpectedAnswer(_assignmentIndex).getList()
				.size() < 1) {
			return false;
		}
		return true;
