...
public abstract class AuthoringGUI extends JFrame implements Observer {
	 ...
	 * @attribute the assignment metadata TODO maybe put the config and the
	 *            metadata inside the assignment already
	 */
	 ...
	 *            framework
	 */
	public final void setComponents(HashMap config, DomainGUI domainGUI,
			HashMap metadata) {
		_config = config;
	 ...
	 *            by the framework
	 */
	public final void setAssignment(String proposition,
			AssignmentState initial, AssignmentState current,
	...
	public Assignment getAssignment() {
		_assignment = new Assignment(getProposition(), getInitialState(),
				getInitialState(), getExpectedAnswer());
